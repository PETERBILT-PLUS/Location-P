...
function Home() {
    ...
    return (
        <>
            <Helmet>
                <title>V Rent Auto Maroc - Louez une Voiture Facilement au Maroc</title>
                <meta name="description" content="Louez une voiture en toute simplicité avec V Rent Auto Maroc. Trouvez et réservez la voiture idéale pour vos besoins parmi une large sélection de véhicules au Maroc." />
                <link rel="canonical" href="https://www.vrentauto.com/" />
            </Helmet>

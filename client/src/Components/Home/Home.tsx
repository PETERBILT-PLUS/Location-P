...
function Home() {
    ...
    return (
        <section className="cars-section py-5 min-vh-100">
            <Helmet>
                <title>V Rent Auto Maroc - Location de Voitures Maroc</title>
                <meta name="description" content="Location de voitures Maroc. Trouvez et réservez la voiture idéale pour vos besoins parmi une large sélection de véhicules au Maroc." />
